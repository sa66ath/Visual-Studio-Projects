...
//	Pre Delay Placement
//------------------------------------------------------------------------------
class ParamPdPost : public VSTParamHasMinMax<bool> {
public:
	ParamPdPost(const char* label, const char* name, bool min, bool max) : VSTParamHasMinMax<bool>(label, name, min, max)	{}
};
...
extern ParamPdPost	paramPdPost;
