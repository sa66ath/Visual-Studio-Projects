...
class BFilterIIR1D : public BFilter
{
	...
	float	coef[3];
	float	lpIngredient, hpIngredient;	///< for kPassTypeNone. 
	...
	void calcCoef()
	{
		...
		switch(passType) {
		case kPassTypeNone:
			a[0] = lpIngredient*b[0];
			a[1] = hpIngredient*b[1]; 
			break;
		case kPassTypeAPF:
			a[0] = b[0];	a[1] = -b[1];
			break;
...
public:
	BFilterIIR1D(PassType pt = kPassTypeLPF, float f = 1000.0, float lpIngredient = 1.0, float hpIngredient = 0.0) : BFilter(pt, f), 
		lpIngredient(lpIngredient), hpIngredient(hpIngredient)	///< for kPassTypeNone
     	{
		calcCoef();
	}

	void setIngredient(float lp, float hp)
	{
		lpIngredient = lp;
		hpIngredient = hp;
	       	calcCoef();
...
class BFilterIIR2D : public BFilter
{
	...
	float	lpIngredient, bpIngredient, hpIngredient;
	...
	void calcCoef()
	{
		...
		case kPassTypeNone:
			a[0] = lpIngredient*b[0];
			a[1] = bpIngredient*b[1];
			a[2] = hpIngredient*b[2];
			break;
		case kPassTypeAPF:
			a[0] = b[0];	a[1] = -b[1];	a[2] = b[2];
			break;
		case kPassTypeHPF:
			a[0] = 0.0;	a[1] = 0.0;	a[2] = b[2];
			break;
		case kPassTypeBPF:
			a[0] = 0.0;	a[1] = b[1];	a[2] = 0.0;
			break;
		case kPassTypeLPF:
		default:
			a[0] = b[2];	a[1] = 0.0;	a[2] = 0.0;
			break;
		}
...
public:
	BFilterIIR2D(PassType pt = kPassTypeLPF, float f = 1000.0, float q = 0.707, float lpIngredient = 1.0, float bpIngredient = 0.0, float hpIngredient = 0.0) : BFilter(pt, f), Q(q),
       		lpIngredient(lpIngredient), bpIngredient(bpIngredient), hpIngredient(hpIngredient)	///< for kPassTypeNone
       	{
		calcCoef();
	}

	void setIngredient(float l, float b, float h)
	{
		lpIngredient = l;
		bpIngredient = b;
		hpIngredient = h;
